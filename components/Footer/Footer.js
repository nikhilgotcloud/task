  ...
  return (
    ...
    <div className="row">
      <div className={`${styles.footer} col p-2`}>
        ...
        <Image className=" mx-2 p-2" src="/homeft.png " width={40} height={40}></Image>
        <Image className=" mx-3 p-2 " src="/chat.png " width={45} height={40}></Image>
        <Image className=" mx-3 p-2" src="/save.png " width={35} height={35}></Image>
        <Image className=" mx-3  p-2" src="/arrow-up-from-square.png " width={35} height={35}></Image>
